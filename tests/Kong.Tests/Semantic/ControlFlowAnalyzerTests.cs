...
public class ControlFlowAnalyzerTests
{
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test() -> int { return 1 }");
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test(x: bool) -> int { if (x) { return 1 } else { return 2 } }");
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test(x: bool) -> int { if (x) { return 1 } }");
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test() -> int { }");
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test() -> int { 42 }");
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test() -> int { return 1 2 }");
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test(x: bool) -> int { if (x) { return 1 } else { return 2 } 3 }");
    ...
    {
        var (_, result) = ParseResolveAndCheck("fn Test(x: bool) -> int { if (x) { return 1 } 2 }");
    ...
    [Fact]
    public void TestWhileLoopDoesNotSatisfyMissingReturnAnalysis()
    {
        var (_, result) = ParseResolveAndCheck("fn Test() -> int { while true { return 1 } }");
